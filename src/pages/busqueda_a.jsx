...
class BusquedaA extends React.Component {
  ...
  render() {
    ...
    <div className="page-content">
      ...
      <div className="page-section">
        <h2>¿Qué es la Búsqueda A*?</h2>
        <p>A* es el método de búsqueda informada más utilizado. Toma la estrategia del método Greedy, de determinar cuál acción de las que podemos tomar nos deja con la menor distancia al objetivo, pero también toma en cuenta el costo que tiene el llegar a esta acción, para que no terminemos tomando caminos demasiado caros. </p>
        <img src={placeholder} className="page-img" alt="pic"></img>
        <p>En A* se utilizan también valores llamados pesos, que utilizamos como ponderación para darle distinta importancia a la distancia recorrida para llegar a un punto versus el valor que la heurística le da al punto. Por ejemplo, si el peso de la distancia y el de la heurística son 1, ambos son igual de importantes. Si el peso de la distancia es 1 y el de la heurística es 0.5, entonces la distancia es doblemente importante que la heurística.</p>
      </div>
      ...
      <Footer prevName="Búsqueda Greedy" prevURL="/busqueda-greedy" nextName="" nextURL="#"/>
    </div>
    </div>
    );
  }
