...
export default class BusquedaBidireccional extends React.Component {
  ...
  render() {
    ...
    <div className="page-content">
      ...
      <div className="page-section">
        <h2>¿Qué es la Búsqueda Bidireccional?</h2>
        <p>Si conocemos el punto inicial y la meta en un problema, podemos realizar búsquedas a partir de ambos puntos al mismo tiempo, y esperar a que se encuentren para combinar sus caminos. Puesto que cada lado de la búsqueda está recorriendo árboles con la mitad de la profundidad original, esto aumenta la eficiencia de la búsqueda. Este método puede aplicarse a búsquedas tanto en anchura como en profundidad.</p>
      </div>
      ...
      <Footer prevName="Búsqueda en profundidad limitada iterativa" prevURL="/busqueda-en-profundidad-limitada-iterativa" nextName="Búsqueda informada" nextURL="/busqueda-informada"/>
    </div>
    </div>
    );
  }
...
//export default connect(mapStateToProps)(BusquedaBidireccional)